...
-- INSERT INTO item (item_code, country, city, title, content_1, content_2, rated, start_price, duration, like_num, category, admin, update_admin,created_date) VALUES ('ITM002', '일본', '도쿄', '도쿄 여행 3박 4일', '<html><body><h1>도쿄 여행 3박 4일</h1></body></html>', '<html><body><p>도쿄의 문화와 역사를 경험하세요!</p></body></html>', 4.8, 100000, 4, 20,2, 1, 2,NOW());
-- INSERT INTO item (item_code, country, city, title, content_1, content_2, rated, start_price, duration, like_num, category, admin, update_admin,created_date) VALUES ('ITM003', '미국', '뉴욕', '뉴욕 자유여행 5박 6일', '<html><body><h1>뉴욕 자유여행 5박 6일</h1></body></html>', '<html><body><p>뉴욕의 놀라운 도시 풍경을 즐기세요!</p></body></html>', 4.9, 150000, 6, 30, 1, 1, 2,NOW());
--
